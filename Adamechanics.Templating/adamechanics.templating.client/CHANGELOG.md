...
- Create Angular project with ng: `ng new adamechanics.templating.client --defaults --skip-install --skip-git `.
...
- Create project file (`adamechanics.templating.client.esproj`).
